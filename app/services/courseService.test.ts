...
describe("courseService", () => {
  ...
  describe("getCourseWithDetails", () => {
    ...
    it("returns modules ordered by position", () => {
      testDb.insert(schema.modules).values({ courseId: base.course.id, title: "Module B", position: 2 });
      testDb.insert(schema.modules).values({ courseId: base.course.id, title: "Module A", position: 1 });
    ...
    it("nests lessons within their modules", () => {
      ...
      testDb.insert(schema.lessons).values({ moduleId: mod.id, title: "Lesson B", position: 2 });
      testDb.insert(schema.lessons).values({ moduleId: mod.id, title: "Lesson A", position: 1 });
    ...
    it("separates lessons into correct modules", () => {
      ...
      testDb.insert(schema.lessons).values({ moduleId: mod1.id, title: "M1 Lesson", position: 1 });
      testDb.insert(schema.lessons).values({ moduleId: mod2.id, title: "M2 Lesson", position: 1 });
  ...
  describe("getLessonCountForCourse", () => {
    ...
    it("counts lessons across all modules", () => {
      ...
      testDb.insert(schema.lessons).values({ moduleId: mod1.id, title: "L1", position: 1 });
      testDb.insert(schema.lessons).values({ moduleId: mod1.id, title: "L2", position: 2 });
      testDb.insert(schema.lessons).values({ moduleId: mod2.id, title: "L3", position: 1 });
